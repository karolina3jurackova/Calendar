        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatRule = table.Column<string>(type: "TEXT", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    LastModified = table.Column<DateTime>(type: "TEXT", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nickname = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ChannelLocal = table.Column<bool>(type: "INTEGER", nullable: false),
                    ChannelEmail = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participants_EventId_UserId_Email",
                table: "Participants",
                columns: new[] { "EventId", "UserId", "Email" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shares_EventId_GroupKey",
                table: "Shares",
                columns: new[] { "EventId", "GroupKey" },
                unique: true);
